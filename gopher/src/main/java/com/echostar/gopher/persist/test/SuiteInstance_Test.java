...
public class SuiteInstance_Test  extends TestClassBase {
	...
	public static void testCreate () throws Exception {
		...
		List<TestRunResult> actualRunResults =
			gopherData.findTestRunResultsByTestRun (testRun.getId());

...

{
...

	{
		Zip.zipDir(System.getProperty("user.dir") + "//XSLT_Reports",
				System.getProperty("user.dir") + "//email_xslt_reports.rar");

		String[] to = { "shekhar.nik@gmail.com" };
	...
	public static boolean sendMail(String userName, String passWord,
...

		{
			...
			msg.setFrom(new InternetAddress("shekhar.nik@gmail.com"));
